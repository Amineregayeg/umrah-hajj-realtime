...
import { PathFindingResult, RouteRequest, Node, NavigationStep } from '../interfaces/graph.interface';
...
export class PathfindingService {
  ...
  private generateSteps(path: string[], totalDistance: number): NavigationStep[] {
